...
;(function() {
    ...
    SIM_PARAMETERS.insertNames = ['SPCF','zwit_aa_G','zwit_aa_A','zwit_PRO','zwit_aa_F','zwit_aa_Y','zwit_aa_W','zwit_aa_E','zwit_aa_K','zwit_aa_R','zwit_aa_S','zwit_aa_T','zwit_aa_V','glucose','methane','octane','dodecane','benzene','benzoate','benzamidine','NAFT','N2','O2','argon','sodium_ion','chloride_ion','potassium','magnesium','calcium','cesium','ammonium','bisulfate','acetate','acetic_acid','ibuprofen','trichloroethane','tribromoethane','crown'];
